...
def process_evaporative_humidifier(
    ...
    return {
        ...
        "target_humidity": (mfr_data[16] & 0b01111111) if mode == HumidifierMode.TARGET_HUMIDITY else None,
        ...
        "temperature": float(mfr_data[10] & 0b01111111) + float(mfr_data[11]>>4)/10 if has_temperature else None,
        "filter_run_time": filter_run_time,
        "filter_alert": filter_run_time >= 240,
        "water_level": HumidifierWaterLevel(mfr_data[11] & 0b00000011) if not is_tank_removed else None,
    }
