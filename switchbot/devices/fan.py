...
COMMAND_HEAD = "570f41"
COMMAND_START_OSCILLATION = f"{COMMAND_HEAD}02010101"  # 左右+上下同时启动
COMMAND_STOP_OSCILLATION = f"{COMMAND_HEAD}02010202"  # 左右+上下同时停止
COMMAND_START_HORIZONTAL_OSCILLATION = f"{COMMAND_HEAD}020101ff"  # 仅启动左右，上下保持
COMMAND_STOP_HORIZONTAL_OSCILLATION = f"{COMMAND_HEAD}020102ff"  # 仅停止左右，上下保持
COMMAND_START_VERTICAL_OSCILLATION = f"{COMMAND_HEAD}0201ff01"  # 左右保持，仅启动上下
COMMAND_STOP_VERTICAL_OSCILLATION = f"{COMMAND_HEAD}0201ff02"  # 左右保持，仅停止上下
COMMAND_SET_MODE = {
