...
class SwitchbotMeterProCO2(SwitchbotDevice):
    ...
    async def set_co2_thresholds(self, lower: int, upper: int):
        ...
        await self._send_command(COMMAND_CO2_THRESHOLDS + f'{lower:04x}' + f'{upper:04x}')
    ...
    async def set_comfortlevel(self, cold: float, hot: float, dry: int, wet: int):
        ...
        await self._send_command(COMMAND_COMFORTLEVEL + hot_byte + f'{wet:02x}' + point_five + cold_byte + f'{dry:02x}')
    ...
    async def set_alert_temperature_humidity(self,
        ...
        *_reverse: If False: Alert if measured value is outside of provided range.
        ...
        temperature_point_five = self._get_point_five_byte(temperature_low, temperature_high)
        ...
        await self._send_command(COMMAND_ALERT_TEMPERATURE_HUMIDITY
    ...
    async def set_alert_co2(self, on: bool, co2_low: int, co2_high: max, reverse: bool):
        ...
        await self._send_command(COMMAND_ALERT_CO2 + f'{mode:02x}' + f'{co2_high:04x}' + f'{co2_low:04x}')
    ...
    async def set_button_function(self, change_unit: bool, change_data_source: bool):
        ...
        await self._send_command(COMMAND_BUTTON_FUNCTION + change_unit_byte + change_data_source_byte)
