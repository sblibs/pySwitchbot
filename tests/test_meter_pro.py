...
@pytest.mark.asyncio
@pytest.mark.parametrize(
    ("temperature_alert", "temperature_low", "temperature_high", "temperature_reverse",
     "humidity_alert", "humidity_low", "humidity_high", "humidity_reverse",
     "absolute_humidity_alert", "absolute_humidity_low", "absolute_humidity_high", "absolute_humidity_reverse",
     "dewpoint_alert", "dewpoint_low", "dewpoint_high", "dewpoint_reverse",
     "vpd_alert", "vpd_low", "vpd_high", "vpd_reverse",
     "expected_payload"),
    [
        (True, -20, 80, True, False, 1, 99, False, False, 0.00, 99.99, False, False, -60.0, 60.0, False, False, 0.00, 10.00, False, "04d063001401bc003c0000a00063630000"),
        (True, -20, 59.5, True, False, 1, 99, False, False, 0.00, 99.99, False, False, -60.0, 60.0, False, False, 0.00, 10.00, False, "04bb63501401bc003c0000a00063630000"),
        (True, -11.5, 59.5, True, False, 1, 99, False, False, 0.00, 99.99, False, False, -60.0, 60.0, False, False, 0.00, 10.00, False, "04bb63550b01bc003c0000a00063630000"),
        (True, -11.5, 59.5, False, False, 1, 99, False, False, 0.00, 99.99, False, False, -60.0, 60.0, False, False, 0.00, 10.00, False, "03bb63550b01bc003c0000a00063630000"),
        (True, -11.5, 59.5, False, True, 20, 80, False, False, 0.00, 99.99, False, False, -60.0, 60.0, False, False, 0.00, 10.00, False, "33bb50550b14bc003c0000a00063630000"),
        (True, -11.5, 59.5, False, True, 20, 80, True, False, 0.00, 99.99, False, False, -60.0, 60.0, False, False, 0.00, 10.00, False, "43bb50550b14bc003c0000a00063630000"),
        (False, -11.5, 59.5, False, True, 20, 80, True, False, 0.00, 99.99, False, False, -60.0, 60.0, False, False, 0.00, 10.00, False, "40bb50550b14bc003c0000a00063630000"),
        (False, -11.5, 59.5, False, False, 20, 80, False, True, 15.00, 70.00, False, False, -60.0, 60.0, False, False, 0.00, 10.00, False, "00bb50550b14bc003c0000a00146000f00"),
        (False, -11.5, 59.5, False, False, 20, 80, False, True, 17.50, 69.50, True, False, -60.0, 60.0, False, False, 0.00, 10.00, False, "00bb50550b14bc003c0000a00245321132"),
        (False, -11.5, 59.5, False, False, 20, 80, False, False, 06.00, 99.99, False, True, -47.0, 41.0, False, False, 0.00, 10.00, False, "00bb50550b14a9002f0000a00c63630600"),
        (False, -11.5, 59.5, False, False, 20, 80, False, False, 06.00, 99.99, False, True, -47.0, 41.0, True, False, 0.00, 10.00, False, "00bb50550b14a9002f0000a01063630600"),
        (False, -11.5, 59.5, False, False, 20, 80, False, False, 06.00, 99.99, False, True, -15.5, 42.5, True, False, 0.00, 10.00, False, "00bb50550b14aa550f0000a01063630600"),
        (False, -11.5, 59.5, False, False, 20, 80, False, False, 06.00, 99.99, False, False, -15.5, 42.5, True, True, 0.00, 10.00, False, "00bb50550b14aa550f0000a06063630600"),
        (False, -11.5, 59.5, False, False, 20, 80, False, False, 06.00, 99.99, False, False, -15.5, 42.5, True, True, 1.05, 8.75, True, "00bb50550b14aa550f4b05818063630600"),


    ],
)
async def test_set_alert_temperature_humidity(temperature_alert: bool , temperature_low: float,  temperature_high: float, temperature_reverse: bool,
             humidity_alert: bool, humidity_low: int, humidity_high: int, humidity_reverse: bool,
             absolute_humidity_alert: bool, absolute_humidity_low: float, absolute_humidity_high: float, absolute_humidity_reverse: bool,
             dewpoint_alert: bool, dewpoint_low: float, dewpoint_high: float, dewpoint_reverse: bool,
             vpd_alert: bool, vpd_low: float, vpd_high: float, vpd_reverse: bool, expected_payload: str):
    # Values based on actual measurements from the app

    device = create_device()
    device._send_command.return_value = bytes.fromhex("01")

    await device.set_alert_temperature_humidity(temperature_alert, temperature_low, temperature_high, temperature_reverse, humidity_alert, humidity_low, humidity_high, humidity_reverse, absolute_humidity_alert, absolute_humidity_low, absolute_humidity_high, absolute_humidity_reverse, dewpoint_alert, dewpoint_low, dewpoint_high, dewpoint_reverse, vpd_alert, vpd_low, vpd_high, vpd_reverse)
...
async def test_set_alert_co2(on: bool, co2_low: int, co2_high: int, reverse: bool, expected_payload: str):
    # Values based on actual measurements from the app
...
async def test_set_button_function(change_unit: bool, change_data_source: bool, expected_payload: str):
    # Values based on actual measurements from the app
